...
const TipButton = ({ content }) => {
    ...
    return (
        <div className="tip flex justify-center items-center flex-col relative">
            ...
            {toggleTipButton && (
                <div className="absolute top-16 w-96 text-center border-2 border-solid p-3 border-yellow-900 duration-300 rounded-xl scale-90 hover:scale-110 bg-yellow-900/50 text-white font-bold">
                    {content}
                </div>
            )}
        </div>
